    ...
    <div className="h-screen w-screen bg-[url('src/assets/bgimage.jpg')] bg-cover ">
      <div className="h-full w-[85%] m-auto  ">
        ...
        <div className="flex flex-col justify-evenly items-center">
          <div className="h-[20%] w-[40%] flex flex-col items-center gap-6 ">
            <h1 className="text-5xl text-gray-800 font-bold text-center text-shadow-2xs">
              Your Bus, Your Time, Tracked{" "}
            </h1>
            <p className="text-[#556275] text-xl flex text-center">
        ...
        <div className=" w-full flex justify-center px-5 mt-10">
          <input
            ...
            className="w-[40%] h-12  border-none outline-none rounded-l-2xl  bg-gray-200 px-5 text-gray-400  text-xl"
          />
        ...
        <div className="w-full  mt-15 h-70 px-5">
          <div className="flex justify-evenly flex-wrap h-full w-full">
            {routes.map((data, index) => (
              <div key={index} className="w-fit flex flex-col p-3 bg-gray-200 h-40  rounded-2xl gap-3 shadow-2xl">
